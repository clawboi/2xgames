...
const Weapons = (() => {
  const defs = [
    { // 0: DRACO — grey
      ...
      magazine: 30, reloadTime: 1200, range: 1500,
      sound: 'shoot', shake: 1,
    },
    { // 1: GLOCK — grey
      ...
      magazine: 22, reloadTime: 650, range: 1500,
    ...
    { // 3: RPG — grey
      ...
      magazine: 4, reloadTime: 2200, range: 2400,
    ...
    { // 4: CRAB LASER — green (special pickup)
      ...
      magazine: 80, reloadTime: 0, range: 1500,
    ...
    { // 5: SAWED-OFF — green shop
      ...
      magazine: 6, reloadTime: 1600, range: 1500,
    ...
    { // 7: GOLD DRACO — gold
      ...
      magazine: 60, reloadTime: 900, range: 1600,
      pierce: true,
    ...
    { // 9: PLASMA CANNON — gold (BUFFED)
      ...
      magazine: 18, reloadTime: 1200, range: 1800,
    ...
    { // 10: TESLA COIL — red (BUFFED chain lightning)
      ...
      magazine: 14, reloadTime: 1400, range: 1800,
    ...
    { // 11: FLAMETHROWER — red (BUFFED DOT stream)
      ...
      magazine: 180, reloadTime: 2000, range: 1500,
    ...
    { // 12: FREEZE GUN — red (OP: fast-fire AOE freeze, shatters frozen crabs into ice)
      ...
      magazine: 30, reloadTime: 1200, range: 1600,
    ...
    { // 13: HONEY UZI — gold (BUFFED)
      ...
      magazine: 80, reloadTime: 1100, range: 1600,
