...
const Weapons = (() => {
  ...
  const defs = [
    ...
    { // 7: GOLDEN DRACO — legendary shop unlock. Faster, more damage, pierces
      key: 'goldDraco', name: 'GOLD DRACO',
      damage: 22, fireRate: 70, bulletSpeed: 11,
      bulletType: 'gold', spread: 0.08, shotsPerFire: 1,
      magazine: 45, reloadTime: 1000,
      pierce: true,
      sound: 'shoot', shake: 1.5, shopUnlock: true, legendary: true,
    },
    { // 8: GOLDEN RPG — legendary shop unlock. Bigger splash, faster reload
      key: 'goldRpg', name: 'GOLD RPG',
      damage: 130, fireRate: 850, bulletSpeed: 8,
      bulletType: 'gold', spread: 0, shotsPerFire: 1,
      magazine: 6, reloadTime: 1500,
      splash: 150, explodeOnExpire: true,
      sound: 'shootBig', shake: 10, shopUnlock: true, legendary: true,
    },
  ];
