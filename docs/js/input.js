...
const Input = (() => {
  ...
  function attachJoystick() {
    ...
    function start(e) {
      // Find any new touch on the left half that isn't already grabbed
      for (const t of e.changedTouches) {
        ...
        stickContainer.style.left = (originX - 55) + 'px';
        stickContainer.style.bottom = 'auto';
        stickContainer.style.top  = (originY - 55) + 'px';
    ...
    function end(e) {
      for (const t of e.changedTouches) {
        ...
        // Return joystick container to its resting CSS position
        stickContainer.style.left = '';
        stickContainer.style.top = '';
        stickContainer.style.bottom = '';
        e.preventDefault();
        return;
      }
    }
