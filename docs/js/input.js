  ...
  function attachJoystick() {
    ...
    function move(e) {
      for (const t of e.changedTouches) {
        ...
        joystick.x += (targetX - joystick.x) * 0.72;
        joystick.y += (targetY - joystick.y) * 0.72;
        return;
      }
    }
    function end(e) {
    ...
    // PASSIVE listeners so iOS Safari doesn't disable native scroll on other pages
    // The canvas already has touch-action:none which blocks browser gestures during gameplay
