  ...
  function drawBullet(ctx, b) {
    ...
    switch (type) {
      ...
      case 'enemy':
        ...
        break;
      case 'plasma': {
        // Plasma — purple energy ball with bright core
      ...
      case 'tesla': {
        // Tesla — bright cyan/white electric sphere
      ...
      case 'flame': {
        // Flame — orange-red fire wisp, flickering
        const f = Math.random();
        ctx.fillStyle = `rgba(255,${100 + Math.floor(f * 100)},0,0.55)`;
        ctx.beginPath(); ctx.arc(x, y, 5 + f * 2, 0, Math.PI * 2); ctx.fill();
      ...
      case 'freeze': {
        // Freeze — icy crystal with cyan glow
      ...
      case 'honey': {
        // Honey — golden honey blob with drip trail
