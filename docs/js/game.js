...
(() => {
  ...
  document.addEventListener('visibilitychange', () => {
    ...
    else { if (game.state === 'menu') Audio.playMusic('menu'); else if (game.state === 'playing') Audio.resume(); }
  });
  ...
  function initCustomizer() {
    ...
    if (randomBtn) randomBtn.addEventListener('click', () => {
      ...
      ['fit','accent','hat','chain','shades','pattern','shirtless','tattoos'].forEach(k => {
        const sel = ({fit:'#fit-swatches .swatch',accent:'#accent-swatches .swatch',hat:'#hat-swatches .hat-btn',chain:'#chain-swatches .hat-btn',shades:'#shades-swatches .hat-btn',pattern:'#pattern-swatches .hat-btn',shirtless:'#shirt-swatches .hat-btn',tattoos:'#tat-swatches .hat-btn'})[k];
