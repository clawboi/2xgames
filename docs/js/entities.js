...
class Crab extends Enemy {
  constructor(x, y, mod = 1) {
    super(x, y, { hp: 6 * mod, speed: 1.0, damage: 8, radius: 12, score: 10 });
...
class FastCrab extends Enemy {
  constructor(x, y, mod = 1) {
    super(x, y, { hp: 4 * mod, speed: 2.1, damage: 5, radius: 10, score: 15 });
    this.frame = Math.floor(Math.random() * 100);
    this.scale = 0.75;
  }
  update(dt, game) {
...
class TankCrab extends Enemy {
  constructor(x, y, mod = 1) {
    super(x, y, { hp: 18 * mod, speed: 0.7, damage: 14, radius: 18, score: 30 });
    this.frame = Math.floor(Math.random() * 100);
    this.scale = 1.5;
  }
  update(dt, game) {
...
class ArmedCrab extends Enemy {
  constructor(x, y, mod = 1) {
    super(x, y, { hp: 8 * mod, speed: 0.85, damage: 6, radius: 13, score: 25 });
    this.frame = Math.floor(Math.random() * 100);
